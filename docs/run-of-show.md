...
Kenny moderates. **If the room is quiet, seven seed questions are in [`seed-questions.md`](seed-questions.md).** Prepared answers for what tends to arrive unprompted:
