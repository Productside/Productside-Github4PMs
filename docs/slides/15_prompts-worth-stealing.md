<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 160" width="960" height="160">
  ...
  <text x="48" y="100" font-family="system-ui, -apple-system, sans-serif" font-size="48" font-weight="800" fill="#FFFFFF" text-anchor="start">Prompts worth stealing.</text>
</svg>
...
**Tracing decisions 3 months later:**
...
> Bring me up to speed. What changed in this repository since Friday? Summarize the product decisions, not just the file edits.
